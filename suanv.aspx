<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="suanv.aspx.cs" Inherits="masterpage2.suanv" %>
...
&nbsp;<asp:DropDownList ID="ddlMaphong" runat="server" size="3" />
      ...
      <p>
        <asp:Button ID="btnSua" runat="server" Text="Sua nhan vien" OnClick="btnSua_Click" />
